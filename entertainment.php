...
$urlSources = file_get_contents("https://newsapi.org/v2/top-headlines?country=ng&category=entertainment&apiKey=aab9ee504ef54b83b7f51d534079c61b");
...
<head>
    ...
    <title>NewsToday — Entertainment</title>
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">24 Entertainment</div>
                </div>
<?php
